...
import 'package:template_flutter_claude/src/feature/auth/src/data/auth_repository.dart';
...
final class _AuthStateError extends AuthState {
  ...
  bool operator ==(Object other) {
    ...
    return other is _AuthStateError && other.status == status && other.error == error;
  }
