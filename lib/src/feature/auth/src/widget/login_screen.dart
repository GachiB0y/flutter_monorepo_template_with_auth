...
import 'package:template_flutter_claude/src/feature/auth/src/dependencies/auth_dependencies.dart';
                ...
                child: SizedBox(
                  ...
                  child: FilledButton(
                    onPressed: () {
                      ...
                      AuthScope.of(context, listen: false).signInWithEmailAndPassword(
