...
import 'package:template_flutter_claude/src/core/rest_client/src/http/check_exception_io.dart'
    if (dart.library.js_interop) 'package:template_flutter_claude/src/core/rest_client/src/http/check_exception_browser.dart';
